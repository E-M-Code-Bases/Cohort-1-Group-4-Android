...
class TrendingSeriesDetailsFragment : Fragment() {
    ...
    private var series: SeriesTrending? = null
    private lateinit var binding: FragmentSeriesDetailsBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        arguments?.let {
            series = it.getSerializable(SeriesName) as SeriesTrending
        }
    }
...
//
    ...
    companion object {
        ...
        fun newInstance(series:SeriesTrending) = TrendingSeriesDetailsFragment().apply {
